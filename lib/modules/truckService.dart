...
class TruckServiceScreen extends StatelessWidget {
  const TruckServiceScreen({super.key});
            ...
            children: [
              Center(
                child: Container(
                  ...
                  height: 170,
                  child: Image.asset('images/truckIcon.png',fit: BoxFit.fitHeight,),
                ),
              ),
              SizedBox(height: 20,),
              ListView.separated(
  ...
  Widget buildCardItem()=> Container(
    ...
    child: Row(
      children: [
        Image.asset('images/truckIcon.png',fit: BoxFit.cover,),
